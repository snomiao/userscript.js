...
(function() {
    ...
    var 取开学时间自课程序号 = 课程序号 => {
        ...
        return (e => e && e[(课程序号 + "").slice(0, 3)])({
            ...
            // "210": new Date('2021-09-XX 00:00:00 GMT+0800'),
        })
    }
    ...
    if (location.hostname.match(/^sc.*\.sit\.edu\.cn$/)) {
        ...
        var 下载近期所有第二课堂活动日历 = async(e) => {
            ...
            await Promise.all(([
                ...
                var url = `/public/activity/activityList.action?pageNo=1&pageSize=50&categoryId=${target[0]}`;
                var actType = target[1];
