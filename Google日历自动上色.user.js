...
var 正则颜色表 = {
    '休|睡': 'Azure',
    '洗漱|收拾|购物|购买|整理|日记|日程|日志|维护|运维|配置': "LightYellow",
    '上学|上班|上课|课程': "skyblue",
    '健身|锻练|热身': "Lime",
    '路上|通勤': "Gainsboro",
    '料理|做饭|吃': "lawngreen",
    '仪式|典礼|祭祀': 'yellow',
    '紧急|重要|考试|测验|吵架|事故': 'OrangeRed',
    '群聊|交流|玩|游戏|知乎|微博|小红书|视频|抖音|bilibili|B站': "Violet",
    '思考|科研|研发|开发|研究|探索': "deepskyblue",
...
var 更新颜色 = () => {
    ...
    颜色分析.forEach(({ 元素, 文本 }) => Object.keys(正则颜色表)
        .filter(正则 => 文本.match(正则))
        .sort((正则1, 正则2) => 文本.match(正则1).index - 文本.match(正则2).index)
        .map(正则 => 元素.style.backgroundColor = 正则颜色表[正则]))
}
